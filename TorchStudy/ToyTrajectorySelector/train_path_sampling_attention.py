...
from models.model_path_sampling_attention import (
    PathSamplingAttentionTrajectorySelector,
)

OUTPUT_DIR = Path(__file__).resolve().parent / "outputs" / "path_sampling_attention"
...
def main() -> None:
    ...
    model = PathSamplingAttentionTrajectorySelector().to(device)
