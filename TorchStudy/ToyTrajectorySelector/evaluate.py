...
from models.model_baseline import BaselineTrajectorySelector

OUTPUT_DIR = Path(__file__).resolve().parent / "outputs" / "baseline"
...
def main() -> None:
    ...
    model = BaselineTrajectorySelector().to(device)
